...
type Params struct {
	...
	ResetBridgeNonce             int64                                  `protobuf:"varint,19,opt,name=reset_bridge_nonce,json=resetBridgeNonce,proto3" json:"reset_bridge_nonce,omitempty"`
}
...
func (m *Params) GetResetBridgeNonce() int64 {
	if m != nil {
...
var fileDescriptor_387b0aba880adb60 = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 19:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ResetBridgeNonce |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
